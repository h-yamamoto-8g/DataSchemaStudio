...
class ValidSampleEditor(QWidget):
    """Valid Sample のフォームエディタ。
    ...
    def _setup_ui(self) -> None:
        ...
        self._code_list = CodeListWidget("サンプルコード")
        self._code_list.changed.connect(self.data_changed)
        form.addRow("Sample Codes", self._code_list)
    ...
    def set_item(self, item: dict[str, Any]) -> None:
        ...
        self._code_list.set_codes(item.get("sample_codes", []))
    ...
    def get_item(self) -> dict[str, Any]:
        return {
            ...
            "sample_codes": self._code_list.get_codes(),
